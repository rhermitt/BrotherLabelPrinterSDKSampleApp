...
public class PrinterModelInfo {
    ...
    public enum Model {
        ...
        MW_170(MW_140BT),
        MW_270(MW_260),
        PT_P715eBT(PORTS_BT_USB, PS_PT),
        PT_P910BT(PORTS_BT_USB, PS_PT_910),
        RJ_3230B(PORTS_NET_BT_USB_BLE, PS_CUSTOM_ONLY),
        RJ_3250WB(PORTS_NET_BT_USB_BLE, PS_CUSTOM_ONLY);
