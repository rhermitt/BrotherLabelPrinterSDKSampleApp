...
package com.example.foodsampleapp.common;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import android.graphics.Matrix;
import com.example.foodsampleapp.FoodApp;
...
public class Common {
    ...
    public static final String CUSTOM_PAPER_FOLDER = FoodApp.getAppContext().getExternalFilesDir(null) + "/customPaperFileSet/";

    public enum UsbAuthorizationState{
        NOT_DETERMINED,
        APPROVED,
        DENIED;
    };

    public static UsbAuthorizationState mUsbAuthorizationState;
